...
const TpBannarSection = () => {
  ...
  return (
    <div className="xsm:mt-[30px]  lg:mt-[32px] mx-[5%]" id="Photograpgs">
      ...
      <div className="flex gap-[17px] items-center mt-[26px] xsm:ms-[10px] lg:ms-[40px] ">
        ...
        <h2 className="sm:font-bold lg:text-xl xsm:font-normal xsm:text-[20px] text-white">
          North Africa
        </h2>
      </div>

      <div className="flex xsm:flex-col  sm:flex-row justify-between items-center mt-[32px] text-white">
        <h1 className="sm:font-medium xl:text-[48px] xsm:text-[30px] xsm:font-normal">
          A trip to the mighty desert
        </h1>

        <div className="xsm:hidden md:flex justify-between items-center gap-5 xsm:mt-[15px] ">
          ...
          {topPakegeImg.map((pakegeImg, index) => (
            <SwiperSlide key={index}>
              <img
                src={pakegeImg}
                alt=""
                className="h-[250px] rounded-sm w-full object-cover"
              />
            </SwiperSlide>
          ))}
        </Swiper>
      ...
      <div className="w-full flex justify-center md:hidden">
        <div className="flex justify-around items-center gap-5 xsm:mt-[15px] ">
          <div className="xsm:h-[30px] xsm:w-[30px] lg:h-[46px] lg:w-[46px] rounded-full bg-white flex justify-center items-center">
            <FaBookmark className="text-xl text-[#FF3B00]" />
          </div>
