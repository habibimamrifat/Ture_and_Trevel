    ...
    <SectionWrapper>
      <div className=" pt-[5%] flex justify-between items-center mx-[5%]">
        ...
        <div className="text-white xsm:font-normal lg:font-bold text-base flex justify-center items-center ">
          <div
            className="mr-4 "
            onClick={() => alert("this feature is still not functional")}
          >
            <Link>
              {" "}
        ...
        <div className="text-white xsm:font-normal lg:font-bold text-base flex gap-1 xsm:pr-[20px] sm:pr-[150px] md:pr-[200px] lg:pr-[108px]">
          ...
          <div
            className={`absolute bg-white ease-in-out  ${
              isSignupClosed === "Signup" ||
              isSignupClosed === "Signin" ||
              isSignupClosed === "Forgetpassword"
                ? " top-0 right-0 "
                : "delay-500 -top-[99999px] -right-[99999px]"
            } `}
          >
            <div
              className={`bg-white absolute right-0 shadow-md shadow-gray-400 z-[100] transition-min-height transition-min-w duration-1000 ${
                ...
                isSignupClosed === "Signin" ||
                isSignupClosed === "Forgetpassword"
                  ? "xsm:min-w-[100vw] sm:min-w-[70vw] md:min-w-[60vw] min-h-max xl:min-h-[964px] xl:min-w-[550px] "
                  : "min-w-0 min-h-0"
              }`}
            >
              <button
                className={`w-[50px] h-[50px] rounded-full flex justify-center items-center bg-black/20 absolute right-5 top-2 ${
                  isSignupClosed === "Signup" ||
                  isSignupClosed === "Signin" ||
                  isSignupClosed === "Forgetpassword"
                    ? " block"
                ...
                onClick={() => setSignupPeramiter(null)}
              >
                <h1 className="text-[12px]">X</h1>
              </button>

              <div
                className={`mt-[80px] ms-[20px] me-[40px] transition-all duration-500 ease-in-out overflow-hidden ${
                  isSignupClosed === "Signup" ||
                  isSignupClosed === "Signin" ||
                  isSignupClosed === "Forgetpassword"
              ...
              >
                {isSignupClosed === "Signup" ? (
                  <SignUpPage
                    ...
                    setIsSignUpClosed={setIsSignUpClosed}
                  />
                ) : isSignupClosed === "Signin" ? (
                  <SignIn
                    isSignupClosed={isSignupClosed}
