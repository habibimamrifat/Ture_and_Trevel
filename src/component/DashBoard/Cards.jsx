...
const Cards = () => {
  return (
    <div>
      <div>
      <u className='text-[#FF3B00]'><h1 className='text-[48px] text-black font-normal'>Credit / Debit Cards</h1></u>
      <div className='w-full shadow-md shadow-[#d2d2d2] rounded-[5px]'>
        <div className='ml-[40px] pb-[61px] pt-[40px]'>
          ...
          <div className='mt-[33px]'>
            ...
            <input type="text" className='w-[482px] h-[48px] border-[1px] text-[#948D8D] border-[#948D8D] rounded-[10px] p-5 text-[20px] font-light ' placeholder='Every One'/>
         ...
         <div className='flex gap-9 mt-[34px]'>
          <div>
              <h1 className='text-[20px] font-medium text-[#FF3B00] mb-[15px]' >Card Type</h1>
              <input type="text" className='w-[482px] h-[48px] border-[1px] text-[#948D8D] border-[#948D8D] rounded-[10px] p-5 text-[20px] font-light ' placeholder='visa'/>
            </div>
          <div>
              <h1 className='text-[20px] font-medium text-[#FF3B00] mb-[15px]' >Card Number</h1>
              <input type="text" className='w-[482px] h-[48px] border-[1px] text-[#948D8D] border-[#948D8D] rounded-[10px] p-5 text-[20px] font-light ' placeholder=''/>
            </div>
         </div>

         <div className='mt-[20px]'>
              <h1 className='text-[20px] font-medium text-[#FF3B00] mb-[15px]' >Expiry Date</h1>
              <input type="text" className='w-[482px] h-[48px] border-[1px] text-[#948D8D] border-[#948D8D] rounded-[10px] p-5 text-[20px] font-light ' placeholder='dd--yyyy'/>
            </div>
