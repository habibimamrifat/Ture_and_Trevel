...
const Profile = () => {
  ...
  return (
    <div>
      <div>
        <h1 className="text-[48px] font-medium text-[#645E5E]">My Profile</h1>

        <div className="mt-[40px] grid grid-cols-12 gap-24 ">
          ...
          <h1 className="text-[20px] font-normal text-black w-[200px] ">Name</h1>
              <p className="text-[16px] font-normal text-[#645E5E]">
                {ProfileDetail.name}
              </p>
            </div>
            <div className="flex gap-72 mt-[30px]">
