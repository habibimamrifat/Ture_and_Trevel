...
const SignIn = ({isSignupClosed , setIsSignUpClosed}) => {
  ...
  return (
    <div className='w-full pb-20'>
                ...
                <h1 className="xsm:text-[30px] xsm:font-normal lg:font-medium lg:text-[36px] text-black">
                Sign In
                </h1>
                <button>
                ...
                <div className="mt-[40px]">
                  ...
                  <input type="text" className="h-[65px] rounded-[10px] bg-[#F1EAEA] mt-[12px] xsm:w-[80%] w-[390px]" />

                  <a href="http:/dashboard">
                    <button className="h-[65px] rounded-[10px] bg-[#FF3B00] mt-[12px] xsm:w-[80%] w-[390px] text-white flex justify-center items-center">
